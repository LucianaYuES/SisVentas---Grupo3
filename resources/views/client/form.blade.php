<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="apellido" class="form-control @error('apellido') is-invalid @enderror" value="{{ old('apellido', $client?->apellido) }}" id="apellido" placeholder="Apellido">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="DNI" class="form-control @error('DNI') is-invalid @enderror" value="{{ old('DNI', $client?->DNI) }}" id="d_n_i" placeholder="Dni">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="correo_electronico" class="form-control @error('correo_electronico') is-invalid @enderror" value="{{ old('correo_electronico', $client?->correo_electronico) }}" id="correo_electronico" placeholder="Correo Electronico">
